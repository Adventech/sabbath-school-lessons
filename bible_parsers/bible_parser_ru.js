...
function parse_ru(read, callback){
  ...
  if (verses){
    for (var i = 0; i < verses.length; i++){
      ...
      if (verse.indexOf(" и ") > 0){
          var new_verse = verse.replace(" и ", "; ");
