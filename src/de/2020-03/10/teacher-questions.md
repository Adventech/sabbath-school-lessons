...
-   Was sagt dieser Bibelabschnitt über Gott aus? Mögliche
    ...
    -   Welche Bedeutung hat die allererste Kleingruppe in der
        Heilsgeschichte zwischen Vater, Sohn und Heiligem Geist? Welches
        erklärte Ziel haben alle drei Personen?
-   Was sagt dieser Bibelabschnitt über den Menschen aus? Mögliche
    Vertiefungsfrage(n):
    -   Warum sind wir Menschen auf Gemeinschaft hin geschaffen? Welche
        Absicht hat Gott von Anfang an damit verfolgt?
-   Was sagt dieser Bibelabschnitt über das Leben mit Gott? Mögliche
    Vertiefungsfrage(n):
    -   Was sagt dieser Text darüber, wie wir unser Leben mit Gott
        gestalten sollen?
    -   Was können wir von der Einheit Gottes lernen?
    -   Inwiefern ist die Gottheit ein Vorbild für alle heutigen
...
-   Was sagt dieser Bibelabschnitt über das Leben mit Gott? Mögliche
    Vertiefungsfrage(n):
    -   Was bedeutet das Delegieren von Verantwortung? Was sind die
        langfristigen Vorteile, wenn die Gemeinde in Kleingruppen
        organisiert ist? Welche Möglichkeiten bieten sie?
    -   Inwieweit lassen sich diese organisatorischen Ratschläge von
        Moses Schwiegervater auf die Bildung von Kleingruppen in
        heutigen Kirchengemeinden übertragen?
    -   Warum ist es wichtig, Kompetenzen, Vollmachten und
        Zuständigkeiten auf mehrere Schultern zu verteilen und nicht in
...
-   Was sagt dieser Bibelabschnitt über das Leben mit Gott? Mögliche
    ...
    -   Was sagt dieser Text darüber, wie wir unser Leben mit Gott
        gestalten sollen?
    -   Wenn die Gemeinde in Kleingruppen aufgeteilt ist: Wie lässt sich
        die hier beschriebene Vielfalt und Einheit der Gemeinde und die
        Abhängigkeit voneinander trotzdem für die ganze Gemeinde
        verwirklichen?
    -   Warum schaffen wir es in Kleingruppen besser als in der ganzen
        Gemeinde, unsere Gaben tatsächlich wirkungsvoll einzusetzen?

Ellen White, Testimonies for the Church, Bd. 7, S. 21–22: „Die Bildung
kleiner Gruppen als Grundlage der christlichen Bemühungen wurde mir von
dem gezeigt, der nicht irren kann. Wenn die Gemeinde zahlreich ist,
sollten sich die Mitglieder in kleine Gruppen aufteilen, um nicht nur
für die Gemeindeglieder, sondern auch für Ungläubige zu arbeiten. Wenn
es an einem Ort nur zwei oder drei gibt, die die Wahrheit kennen, sollen
sie sich in einer Arbeitsgruppe zusammenschließen. Sie sollen das Band
der Einheit erhalten, in Liebe und Einigkeit zusammenstehen und einander
ermutigen, um sich weiterzuentwickeln, damit jeder Mut und Stärke durch
die Unterstützung der anderen gewinnt.“

-   Wie kann dieser göttliche Rat in eurer Gemeinde zur Realität werden?
    Was müsste sich ändern?
-   Wer von uns kann aus Erfahrung berichten, wie das Heim zu einem
    Einflusszentrum werden kann? Warum wäre es für alle, die solche
    Treffen nicht kennen, wertvoll, sich Gedanken über einen eigenen
    Hauskreis zu machen oder bei einem bestehenden beizutreten? Warum
