...
-   Was versteht ihr unter Bibelauslegung
-   Warum ist Bibelauslegung wichtig?
-   Fallen euch Begebenheiten aus der Bibel ein, wo Bibelauslegung
    stattgefunden hat?

**Lukas 24,36-45 (evtl. nur Verse 44-45 lesen)**

-   Fragen zum Text:
    -   Die Jünger haben die Schrift gut gekannt und zusätzlich dazu
        noch 3,5 Jahre mit Jesus verbracht. Warum haben sie ihn jetzt
        nicht erkannt?
        -   (ggf. Welche Vorannahmen über Jesus hinderten sie daran, ihn
            jetzt zu erkennen? )
-   Fragen zur Botschaft:
    -   Welche Vorannahmen könnte es heute geben, die unser Verständnis
        der Schrift beeinflussen?
        -   Habt ihr damit selbst Erfahrungen gemacht?
    -   Vorannahmen sind oft unbewusst. Sie limitieren aber unser
        Verständnis. Sie sind wie eine Brille, durch die wir den
        Bibeltext lesen.
        -   Warum ist es wichtig, seine Prämissen klar definieren zu
            können?
        -   Wie kommt man seinen eigenen Vorannahmen auf die Spur?
    -   Auf S. 68 in der Lektion steht der Satz “Völlige Neutralität
        oder absolute Objektivität ist nicht möglich”.
        -   Inwieweit können wir dann unseren Erkenntnissen aus der
            BIbel überhaupt trauen?
        -   Wie passt diese Aussage damit zusammen, dass uns der Geist
            “in alle Wahrheit leiten” will? (Johannes 16,13)

**Zum Thema Bibelübersetzungen**

-   Fragen zum Thema:
    -   In der Adventgemeinde werden verschiedene Bibelübersetzungen
        verwendet.
        -   Wie erklären sich die Unterschiede in den Übersetzungen?
            (Warum gibt es so viele Übersetzungen?)
        -   (Warum gibt es nicht die *eine* richtige Übersetzung, die
            alle verwenden?)
    -   Woraus ist bei der Auswahl einer Bibelübersetzung zu achten?
    -   Wie geht ihr damit um, dass Übersetzer nicht inspiriert sind und
        möglicherweise nicht immer die ideale Übersetzung finden? (evtl.
        falsche Vorannahmen haben usw.)?
        -   Kennt ihr Beispiele für Bibeltexte, die nicht optimal
            übersetzt sind und bei denen wir als Adventisten eine an
