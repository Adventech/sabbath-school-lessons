...
-   Fragen zum Text:
    -   Nehmen wir an, die Geschichte des Königs David wäre nur ein
        Mythos. Wie würde dies die Bibelauslegung beeinflussen? (Bedenke
        beispielsweise die Geschichte Israels, die heilsgeschichtliche
        Bedeutung des davidischen Königtums, etc.)
