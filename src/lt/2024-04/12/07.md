...
`1. Kokie sprendimų priėmimo procesai gali padėti jums nepadaryti
tos klaidos, kurią padarė Pilotas?`
`2. Kodėl Jėzus turėjo mirti vietoj mūsų? Kodėl Jis turėjo užimti mūsų
vietą? Kodėl Jo mirtis buvo būtina, jei norime būti išgelbėti? Kokios
Šventojo Rašto eilutės patvirtina jūsų atsakymą?`
`3. Koks yra Šventojo Rašto įrodymų ir istorinių įrodymų santykis, kai
kalbama apie tikėjimą Jėzaus prisikėlimu? Tai yra, kokie istoriniai
įrodymai stipriai patvirtina Jėzaus prisikėlimą?`
`4. Pagalvokite apie 1 Kor 15, 12–20. Kaip suprasti mintį, kad be Kristaus
