...
`1. Pasiruošimas priimti Įstatymą padėjo tautai suprasti būtiną pagarbos
jausmą. Kur šiandien mūsų bažnyčioje ir bažnytiniame gyvenime
yra panašus pagarbos jausmas Dievui? O gal jis kažkaip
lėtai išblėso?`

`2. Įsigilinkite į šią Sandoros formulę: „Aš būsiu jūsų Dievas, o jūs būsite
Mano tauta“. Ką tai reiškia mums šiandien ir kaip tai turėtų
atsiskleisti tiek asmeniniame, tiek bendruomenės gyvenime?`

`3. Liepdamas mums kažką atlikti, Dievas įgalina mus. E. Vait rašė:
„Visi Jo įsakai suteikia jėgų ir numato galimybes“ (Paslėpti lobiai,
p. 297). Kaip šį pažadą, šį dabar, įgyvendinti?`

`4. Kaip reaguoti į dažnai girdimą argumentą, kad po kryžiaus Įstatymas
