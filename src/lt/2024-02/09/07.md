...
`Pasaulis keičiasi itin greitai, itin dramatiškai. Kodėl visada turime
būti budrūs, kad paskutiniųjų dienų įvykiai neužkluptų mūsų nepasiruošusių?`

`Kaip teismo ir Dievo Įstatymo supratimas dera su tuo, kad esame
išgelbėti tik malone?`

`Kaip galite paliudyti tiems, kurie nesuvokia tikrosios sabatos reikšmės
ir nuoširdžiai laikosi sekmadienio, pirmosios savaitės dienos?`

`Kokie pavojai slypi Bažnyčios ir valstybės galių sąjungoje? Koks
