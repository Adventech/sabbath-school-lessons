...
“So the Lordord All-Powerful says, ‘A worker heats metal in a fire to test [to remove the parts that are not wanted in] it and see if it is pure [free from other metals]. I will test the people of Judah like [the same as] that. I have no other choice. My people have sinned’ ” (Jeremiah 9:7, ERV).
