...
3. Does not puff up (physioō). The verb physioō occurs in 1 Corinthians 8:1 in Paul’s remarkable statement, “ ‘Knowledge’ puffs up, but love builds up” (ESV). It refers to a person inflated with self-importance.

4. Does not behave rudely (aschēmoneo). The verb aschēmoneo may have an ample range of meanings. By and large, though, it means acting contrary to social and moral standards in a dishonorable, shameful, indecent, or improper manner. Paul likely is referring to the arrogant and rude behavior of the “strong” party toward the “weak” members in Corinth (1 Cor. 4:10, 1 Corinthians 8).
