...
let spanishAudio = async function () {
    await dailyAudio(
        ...
        function (targetDate, week, day) {
            ...
            return `https://www.audioescuelasabatica.com/wp-content/uploads/2026/01/LECCION-${week}-${mapping[day-1]}.mp3`
        },
        2,
        7
    )
...
let ukrainianAudio = async function () {
    await dailyAudio(
        ...
        function (targetDate, week, day, targetQuarter) {
            return `https://sabbath-school-media-tmp.s3.us-east-1.amazonaws.com/audio/uk/${targetQuarter}/${targetDate.format('YYYY-MM-DD')}.m4a`
        },
        2,
        7
    )
